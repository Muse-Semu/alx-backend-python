...
SECRET_KEY = 'django-insecure-fk7oy5yt0f)rfq6v1l=go=w7h-ov9-k56=wbakhfwp6(e0huv+'
...
MIDDLEWARE = [
    ...
    'chats.middleware.RolePermissionMiddleware', # Add role-based permission middleware
